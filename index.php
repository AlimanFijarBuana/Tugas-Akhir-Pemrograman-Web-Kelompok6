      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1> Temukan mobil yang memberikan kenyamanan terbaik</h1>
            <p>Kami siapkan beberapa opsi untuk anda </p>
            <a href="car-listing.php" class="btn">Cek Mobil <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
