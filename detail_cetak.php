...
<head>
	...
	<link href="assets/images/UPBLOGO.png" rel="icon" type="images/x-icon">
				...
				<tbody>
					<tr>
						<td rowspan="3" width="16%" class="text-center">
							<img src="assets/images/UPBLOGO.png" alt="logo-dkm" width="80" />
						</td>
						<td class="text-center"><h3>Rental Mobil</h3></td>
						<td rowspan="3" width="16%">&nbsp;</td>
					</tr>
					<tr>
						<td class="text-center"><h2>RENTAL MOBIL CIKARANG</h2></td>
					</tr>
					<tr>
						<td class="text-center">Jl. Inspeksi Kalimalang No.9, Cibatu, Cikarang Sel., Kabupaten Bekasi, Jawa Barat 17530</td>
					</tr>
				</tbody>
			</table>
			<hr class="line-top" />
