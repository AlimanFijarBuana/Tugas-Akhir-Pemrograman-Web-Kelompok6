...
function buatKode($tabel, $inisial){
    ...
    $panjang  = 8; // Sesuaikan dengan panjang kolom primary key pada tabel Anda
    ...
    if ($row[0] === null) {
        ...
        $angka = intval(substr($row[0], strlen($inisial)));
        $angka++;
    }

    $angka = strval($angka); 
    $tmp   = str_repeat('0', $panjang - strlen($inisial) - strlen($angka));
