    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo"> <a href="index.php"><img src="assets/images/rentalcikarang.png" alt="image"/></a> </div>
        </div>
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="mailto:info@example.com">rentalmobilcikarang@gmail.com</a> </div>
            <div class="header_widgets">
            ...
            <div class="social-follow">
              <ul>
                ...
                <li><a href="https://gmail.com"><i class="fa fa-google-plus-square" aria-hidden="true"></i></a></li>
